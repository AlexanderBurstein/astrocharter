...
class Dyne_aspect_p_h
{
  public static function GetAspectPowerHarmony($longitude, $house_pos, $unknown_bt, &$p_h, $last_planet)
  {
...
// is there an aspect within orb?
        ...
        if ($q > 1) {
          ...
          if ($y == 5 Or $x == 5) {
            $p_h[$x][$y] += ($dyne_val / 2);
          }        // Jupiter aspects treated as harmonious

          if ($y == 3 Or $x == 3) {
            $p_h[$x][$y] += ($dyne_val / 4);
          }        // Venus aspects treated as harmonious
